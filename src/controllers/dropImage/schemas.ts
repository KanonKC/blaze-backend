...
export const updateDropImageSchema = z.object({
    ...
    invalid_message: z.string().max(500).nullable().optional(),
    not_image_message: z.string().max(500).nullable().optional(),
    contain_mature_message: z.string().max(500).nullable().optional(),
